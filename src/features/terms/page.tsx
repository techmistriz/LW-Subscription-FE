    ...
    <section className="w-full">
      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-10 sm:space-y-12">
        ...
        <section className="space-y-3 sm:space-y-4">
          ...
          <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            LexWitness.com provides legal news, articles, resources, and
            consultation services. You agree to use the Site only for lawful
          ...
          <ul className="list-disc pl-5 sm:pl-6 text-sm sm:text-base text-gray-700 space-y-2">
            ...
            <li>
              Do not attempt to disrupt or interfere with the Site’s operation
              or security.
            </li>
            <li>
              All content is for informational purposes and is not legal advice.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3 sm:space-y-4">
          ...
          <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            the confidentiality of your account credentials. Notify us
        ...
        <section className="space-y-3 sm:space-y-4">
          ...
          <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            software, is owned by LexWitness or its licensors and protected by
        ...
        <section className="space-y-3 sm:space-y-4">
          ...
          <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            We may suspend or terminate your access at any time for conduct we
        ...
        <section className="space-y-3 sm:space-y-4">
          ...
          <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            Your use of the Site is also governed by our Privacy Policy. We
        ...
        <section className="space-y-3 sm:space-y-4">
          ...
          <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            resolved in the courts located in Delhi, India.
          </p>
        </section>
...
export const metadata = {
  ...
  description:
    "Professional Terms and Conditions for LexWitness.com legal platform.",
};
