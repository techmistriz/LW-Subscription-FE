  ...
  return (
    ...
    <div className="relative h-[48px]">
      ...
      >
        ...
        {years.map((y: any) => (
          <option key={y} value={y} className="text-white bg-black">{y}</option>
        ))}
      </select>
    ...
    <div className="relative h-[48px]">
      ...
      >
        ...
        {categories.map((cat) => (
          <option key={cat.id} value={cat.id} className="text-white bg-black">{cat.name}</option>
        ))}
      </select>
      <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none z-20">
        <ChevronDown 
    ...
    <div className="relative h-[48px]">
      ...
      >
        ...
        {authors.map((auth) => (
          <option key={auth.id} value={auth.id} className="text-white bg-black">{auth.name}</option>
        ))}
      </select>
      <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none z-20">
        <ChevronDown 
