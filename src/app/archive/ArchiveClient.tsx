...
import { categories as getCategories } from "@/lib/api/categories";
...
const [yearOpen, setYearOpen] = useState(false);
  ...
  const yearId = searchParams.get("year_id") ? Number(searchParams.get("year_id")) : undefined;
  ...
  // COMPUTED VALUES
  // ===========================================================================
  const hasActiveFilters = selectedYearId || selectedCategoryId || selectedAuthorId || searchTerm;
    ...
    <section className="bg-white">
      ...
      <div className="max-w-6xl px-4 mx-auto py-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2">
        ...
        <select
          ...
          onChange={(e) =>
            setSelectedAuthorId(e.target.value ? Number(e.target.value) : undefined)
          }
          className="bg-white border border-gray-300 px-4 py-2"
          disabled={loading}
        >
