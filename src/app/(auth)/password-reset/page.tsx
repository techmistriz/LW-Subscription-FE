...
export default function PasswordResetPage() {
  ...
  return (
    <main className="bg-white">
      <section className="h-35 bg-cover bg-center flex items-center" style={bannerImg}>
        <div className="max-w-6xl mx-auto w-full px-4 flex justify-between items-center">
          <h1 className="text-white text-2xl font-bold uppercase">Password Reset</h1>
          <p className="text-sm text-gray-200">
            <Link href="/" className="text-[#c9060a]">Home</Link> | Password Reset
          </p>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-2xl font-semibold uppercase">Reset Your Password</h2>
          ...
          <div className="mt-12 bg-white border shadow-[0_0_15px_rgba(0,0,0,0.15)] p-8 max-w-105 mx-auto text-left">
            ...
            <form onSubmit={handleSubmit} action="">
              <label className="text-sm font-medium block mb-2">Username or Email</label>
              <input
                required
                type="email"
                value={email}
